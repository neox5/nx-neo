...
describe("simple-component e2e", () => {
  it("should create simple-component", async () => {
    const plugin = uniq("simple-componenent");
    ensureNxProject("@nx-neo/nx-neo", "dist/libs/nx-neo");

    await runNxCommandAsync(`generate @nx-neo/nx-neo:simple-component ${plugin}`);
